...
public class Product extends Tag {
    ...
    public static final Product directory_service = new Product("directory_service");
    ...
    public static final Product iot = new Product("iot");
    ...
    public static final Product registrar = new Product("registrar");
